...
subtitle: A stack of licenses governing the Python language.
whyThisLicense: You want a license compatible with the PSF (Python Software Foundation) license stack.
url: https://opensource.org/licenses/Python-2.0
traits: [permissive, commercial-ok, no-patent, comprehensive, no-network]
popularity: 35
permissions:
  - label: Commercial use
    example: Used by the entire Python community.
conditions:
  - label: License & copyright notice
    example: Keep the PSF copyright.
limitations:
  - label: Liability
    example: No liability.
headerStatement: |-
  This software and documentation are Copyright (c) 2001-2023 Python Software Foundation.
  All Rights Reserved.
---
...
6. This License Agreement shall be governed by and interpreted in all respects by the law of the State of California,
   excluding conflict of law provisions. Nothing in this License Agreement shall be deemed to create any relationship of
   ...
   or any third party. As an exception, the "BeOpen Python" logos available at http://www.pythonlabs.com/logos.html may
...
BY CLICKING ON "ACCEPT" WHERE INDICATED BELOW, OR BY COPYING, INSTALLING OR OTHERWISE USING PYTHON 1.6, beta 1 SOFTWARE,
...
this permission notice appear in supporting documentation, and that the name of Stichting Mathematisch Centrum or CWI
