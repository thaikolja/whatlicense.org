          ...
          <header class="flex items-center justify-between mb-6 shrink-0 relative z-10">
            <div class="flex items-center gap-4">
              <select
                  ...
                  class="bg-charcoal text-cream text-xs font-bold rounded-lg px-3 py-1.5 border border-bark outline-none focus:ring-1 focus:ring-tan cursor-pointer"
              >
                <option
