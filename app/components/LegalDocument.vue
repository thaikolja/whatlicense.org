...
>
/**
 * Shared layout for Privacy Policy / Terms of Service pages.
 */
defineProps<{
...
<template>
  <article class="w-full max-w-3xl mx-auto py-8 sm:py-12 animate-fade-up">
    ...
    <div class="legal-prose space-y-8 text-charcoal/90 leading-relaxed">
      <slot />
    </div>
